...
public class DocumentCalibration {
    private static final List<String> calibrationDocument = new ArrayList<>(LoadFile.inputFromFile());
    ...
    public static void start() {
        LaunchProgram.launchProgram("1", "2", DocumentCalibration.class,
    ...
    public static void startDayTwo() {
        ...
        System.out.println("The answer to part two is : " + sumOfCalibration);
    }
